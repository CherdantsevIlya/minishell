...
/*   Updated: 2022/01/29 23:56:39 by abridger         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//*** ft_action.c ***//
// int			action(t_shell *data); // раскомментировать
...
int			action(t_shell *data, char **envp); // для теста
int			ft_init_data(t_shell *data, char **envp); // для теста
